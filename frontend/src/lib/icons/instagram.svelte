...
>
	<defs>
		<radialGradient id="gradient" r="150%" cx="30%" cy="107%">
			<stop stop-color="#fdf497" offset="0" stop-opacity="1" />
			<stop stop-color="#fdf497" offset="0.05" stop-opacity="1" />
			<stop stop-color="#fd5949" offset="0.45" stop-opacity="1" />
			<stop stop-color="#d6249f" offset="0.6" stop-opacity="1" />
			<stop stop-color="#285AEB" offset="0.9" stop-opacity="1" />
		</radialGradient>
	</defs>
	<path
		fill="url(#gradient)"
